...
(function(){
  const dict = {
    ...
    'หินควอตซ์':'Quartz','หินอ่อนอัด':'Compressed Marble','หินเทอราซโซ่':'Terrazzo','หินคริสตัล':'Crystal','หินซินเทอเรส':'Sintered',
    ...
    'หินอ่อนอัดเป็นวัสดุที่ผลิตให้มีลวดลายและโทนสีสม่ำเสมอ เหมาะสำหรับ ผนัง เคาน์เตอร์ และงานตกแต่ง':'Compressed marble is manufactured for consistent patterns and tones, suitable for walls, countertops and decorative applications.',
    ...
    'ผลงานของเรา':'Project references and material applications','ประเภทงาน:':'Project type:','บ้านพักอาศัย':'Residential','แนวทางวัสดุ:':'Material approach:','หินและไม้สำหรับพื้นที่ส่วนกลางและพื้นที่อยู่อาศัย':'Stone and wood for common and living areas','จุดเน้น:':'Focus:','ความอบอุ่น ดูสะอาด และใช้งานได้จริง':'Warm, clean and practical',
  ...
  // Static English labels are also mapped back to Thai so the TH/EN switch is two-way.
  const reverse={}; Object.keys(dict).forEach(k=>reverse[dict[k]]=k);
  Object.assign(reverse,{
    'OUR SERVICES':'บริการของเรา','NATURAL STONE':'หินธรรมชาติ','SYNTHETIC STONE':'หินสังเคราะห์','WOOD FLOOR COLLECTION':'พื้นไม้ของเรา','OTHER PRODUCTS':'สินค้าอื่นๆ',
    'OUR PROJECTS':'ผลงานของเรา',"LET'S CREATE SOMETHING BEAUTIFUL":'มาสร้างสิ่งสวยงามไปด้วยกัน','CONTACT US':'ติดต่อเรา','CONTACT BMC HOMEMART':'ติดต่อ BMC HOMEMART',
    'MENU':'เมนู','PRODUCTS':'สินค้า','VIEW PRODUCTS':'ดูสินค้า','REQUEST SAMPLE':'ขอตัวอย่างสินค้า','SERVICE DETAIL':'รายละเอียดบริการ','OUR PROCESS':'ขั้นตอนการทำงาน','WHY BMC':'ทำไมต้อง BMC',
    'PREMIUM MATERIALS FOR BETTER LIVING':'วัสดุคุณภาพเพื่อการอยู่อาศัยที่ดียิ่งขึ้น','INSTALLATION':'งานติดตั้ง','STONE FABRICATION':'งานแปรรูปหิน','SURFACE CARE':'บริการดูแลพื้นผิว','FLOOR CARE':'งานขัดและดูแลพื้นผิว',
    'Residential':'บ้านพักอาศัย','INTERIOR':'งานตกแต่งภายใน','SURFACE':'พื้นผิว','DETAIL':'รายละเอียด','COMMERCIAL':'พื้นที่เชิงพาณิชย์'
  });
